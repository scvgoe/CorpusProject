...
public class Relative3Combinator extends Combinator {
	public static Sentence combinate (Sentence s1, Sentence s2) {
		// 복문 생성 함수
		// 관계 부사 where 결합
		// S1 (subject, (where S2), verb ...)
		...
		String text = s1.text.substring(0, targetEntity1.charOffsetEnd+1) +
				", where " + insertedString +
				" " + s1.text.substring(targetEntity1.charOffsetEnd+1);
